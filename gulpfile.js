...
gulp.task('xyc',function(){
	gulp.watch('dev/js/summer.*.js', ['init_xyc','summer', 'summer_update_xyc']);
	
	gulp.watch('dev/js/Frameworks/**/*.js', ['init_xyc','iuapmobile.frameworks.core','iuapmobile.frameworks.core_copy_xyc']);
	
	gulp.watch('dev/js/plugins/*.js', ['init_xyc','iuapmobile.frameworks.ui','iuapmobile.frameworks.ui_copy_xyc']);

	gulp.watch('dev/js/Frameworks/UM.Listview.js', ['init_xyc','iuapmobile.frameworks.listview','iuapmobile.frameworks.listview_copy_xyc']);

	//监听umcss
	gulp.watch('dev/css/iuapmobile.um.css', ['init_xyc','umcss','umcss_copy_xyc']);
...
var PATH_xyc = {
	gitPath : '../../git',//改写成你的真实路径
	studioPath : '../../../software/UAPMobile/iUAPMobile'//改写成你的真实路径
};
var TASKPATH_xyc = {
	git:{},
	studio:{},
...
gulp.task('init_xyc',function(){
	//1、css git path
	TASKPATH_xyc.git["tpl_ump_css"] = PATH_xyc.gitPath + '/publibs/resources/designer/templates/system/webtemplates/frametemplate/ump/projects/default/css';
	TASKPATH_xyc.studio["tpl_ratchet_css"] = PATH_xyc.gitPath + '/publibs/resources/designer/templates/system/webtemplates/frametemplate/ratchet/projects/default/css';
	TASKPATH_xyc.git["tpl_files_css"] = PATH_xyc.gitPath + '/publibs/resources/designer/templates/system/webtemplates/files/css';
	/*
	//2、css studio path
	TASKPATH_gct.studio["tpl_ump_css"] = PATH_gct.studioPath + '/MOB/designer/templates/system/webtemplates/frametemplate/ump/projects/default/css';
	TASKPATH_gct.studio["tpl_ratchet_css"] = PATH_gct.studioPath + '/MOB/designer/templates/system/webtemplates/frametemplate/ratchet/projects/default/css';
	...
	*/
	...
	//3、js git path
	TASKPATH_xyc.git["tpl_ump_js"] = PATH_xyc.gitPath + '/publibs/resources/designer/templates/system/webtemplates/frametemplate/ump/projects/default/js';
	TASKPATH_xyc.git["tpl_ump_js_fw"] = TASKPATH_xyc.git["tpl_ump_js"] + '/frameworks';
	TASKPATH_xyc.git["tpl_ratchet_js"] = PATH_xyc.gitPath + '/publibs/resources/designer/templates/system/webtemplates/frametemplate/ratchet/projects/default/js';
	TASKPATH_xyc.git["tpl_files_js"] = PATH_xyc.gitPath + '/publibs/resources/designer/templates/system/webtemplates/files/js';
...
gulp.task('summer_update_xyc',function(){
	var srcFiles = [];//需合并的源文件数组
	srcFiles.push("dev/js/summer.cordova.js");//1
	srcFiles.push("dev/js/summer.util.js");//2
	srcFiles.push("dev/js/summer.dom.js");//3
	...
	var fileName =  "summer";//目标文件名
	//2 update gityy
	var path1 = TASKPATH_xyc.git["tpl_ump_js"];
	var path2 = TASKPATH_xyc.git["tpl_ratchet_js"];
	var path3 = TASKPATH_xyc.git["tpl_files_js"];
...
gulp.task('iuapmobile.frameworks.core_copy_xyc',function(){
	...
	//2 update git.yonyou.com
	var path11 = TASKPATH_xyc.git["tpl_ump_js_fw"];
	var path3 = TASKPATH_xyc.git["tpl_files_js"];
...
gulp.task('iuapmobile.frameworks.ui_copy_xyc',function(){
